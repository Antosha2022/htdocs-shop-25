...
<h3>карточка клієнта: оновлення</h3>
...
<form method="post" action="{{route('client-update-submit',$data->id)}}">
<!-- <form method="post" action="product/submit"> -->
  ...
  <div class="form-group">
    ...
    <input type="text" name="edrpou_code" value="{{$data->edrpou_code}}" id="edrpou_code" class="form-control">
  </div>
  <div class="form-group">
    <label for="ipn_code">введіть індивідуальний податковий код</label>
    <input type="text" name="ipn_code" value="{{$data->ipn_code}}" id="ipn_code" class="form-control">
  </div>
  <div class="form-group">
    <label for="zip_code">введіть поштовий індекс</label>
    <input type="text" name="zip_code" value="{{$data->zip_code}}" id="zip_code" class="form-control">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="contract_number" value="{{$data->contract_number}}" id="contract_number" class="form-control">
  </div>
  <div class="form-group">
    <label for="contract_date">введіть дату договору</label>
    <input type="date" name="contract_date" value="{{$data->contract_date}}" id="contract_date" class="form-control">
  </div>
  <div class="form-group">
    <label for="chipping_address">введіть адресу доставки</label>
    <textarea class="form-control" name="chipping_address" id="chipping_address" rows="3">{{$data->chipping_address}}</textarea>
  </div>
