...
<!-- добавление кнопки входа и виходу для зареєстораних -->
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-top">
                    <div class="col-md-6">
                      ...
                      <img class="card-img-top mb-5 mb-md-0" src="/mediaFiles/img30hml.png" alt="100% морська вода очищена" />


                    </div>
                    <div class="col-md-6">
                        <div class="small mb-1">SKU: BST-498</div>
                        <h1 class="display-5 fw-bolder">Спрей назальний гіпертонічний 30 мл</h1>
                        <div class="fs-5 mb-5">
                            56.00 ГРН
                            ...
                            <span>95.00 ГРН</span> -->
                              ...
                              <p class="lead">
                                @include('layouts.instructions.30hml')
                              </p>
        ...
        <section class="py-5 bg-light">
            <div class="container px-4 px-lg-5 mt-5">
                <h2 class="fw-bolder mb-4">Дивіться також</h2>
