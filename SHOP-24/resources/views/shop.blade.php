    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="https://a.com.ua/search?term=%D0%B0%D0%B7%D0%BE%D0%B2%D0%B0">купити в аптеці</a>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="mediaFiles/img70ml.png" alt="спрей назальний 70 мл 100% вода морська очищена" />
                            <!-- Product details-->
